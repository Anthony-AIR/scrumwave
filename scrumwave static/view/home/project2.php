      ...
      <!-- de tweede kolom van deze row -->
        <td class="backlog">
          ...
          <div class="TaskForm" id="TaskForm<?php echo $project["Id"]?>" name="TaskForm">
            <form name="addTask" method="post" action="#" class="form-container2"><br><br>
              ...
              if( $task['projectId'] == $project['Id'] ){
                ...
                <div class="myTask" id="myTask" name="myTask<?php echo $task["Id"] ?>">
                  <form name="update-<?php echo $task["Id"]?>" method="post" action="#" class="form-container2"><br><br>
                      ...
                      <input type="text" name="taskId" value="<?php echo $task['Id'] ?>" hidden><br><br><br><br><br>
